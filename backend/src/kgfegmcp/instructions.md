...
```bash
fastmcp inspect src/kgfegmcp/app.py:mcp
fastmcp run src/kgfegmcp/app.py:mcp --transport stdio
fastmcp install claude-desktop src/kgfegmcp/app.py:mcp --with-editable .
```
